...
class InternalPlayerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        playerView.findViewById<View>(R.id.telecima_subtitle_menu)?.setOnClickListener {
            showMainSubtitleMenu()
        }

        playerView.findViewById<View>(R.id.telecima_overflow_menu)?.setOnClickListener {
            showMoreOptionsMenu()
        }
    ...
    private fun maybePersistPreferredSubtitleLanguageAfterSuccessfulCheck(languageCode: String) {
        ...
        lifecycleScope.launch {
            val ok = TvAppMePreferencesClient.patchPreferredSubtitleLanguage(
                baseUrl = base,
                bearerToken = token,
    ...
    private fun hideTrialNonScrubberControllerViews() {
        val ids = intArrayOf(
            ...
            R.id.telecima_subtitle_menu,
            R.id.telecima_overflow_menu,
        )
        for (id in ids) {
