...
class TranslationsDa with BaseTranslations<AppLocale, Translations> implements Translations {
	...
	@override late final _TranslationsMyTelegramDa myTelegram = _TranslationsMyTelegramDa._(_root);
}
...
// Path: myTelegram
class _TranslationsMyTelegramDa implements TranslationsMyTelegramEn {
	_TranslationsMyTelegramDa._(this._root);
...
class _TranslationsVideoControlsPipErrorsDa implements TranslationsVideoControlsPipErrorsEn {
	...
	@override String get permissionDisabled => 'Billede-i-billede-tilladelse er deaktiveret. Aktivér i Indstillinger > Apps > OXPlayer > Billede-i-billede';
...
class _TranslationsCompanionRemotePairingDa implements TranslationsCompanionRemotePairingEn {
	...
	@override String get tipDesktop => 'Åbn OXPlayer på din desktop og aktivér fjernbetjening fra indstillinger eller menu';
...
extension on TranslationsDa {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'videoControls.pipErrors.permissionDisabled' => 'Billede-i-billede-tilladelse er deaktiveret. Aktivér i Indstillinger > Apps > OXPlayer > Billede-i-billede',
			...
			'companionRemote.pairing.tipDesktop' => 'Åbn OXPlayer på din desktop og aktivér fjernbetjening fra indstillinger eller menu',
