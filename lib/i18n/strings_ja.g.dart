...
class TranslationsJa with BaseTranslations<AppLocale, Translations> implements Translations {
	...
	@override late final _TranslationsMyTelegramJa myTelegram = _TranslationsMyTelegramJa._(_root);
}
...
// Path: myTelegram
class _TranslationsMyTelegramJa implements TranslationsMyTelegramEn {
	_TranslationsMyTelegramJa._(this._root);
...
class _TranslationsVideoControlsPipErrorsJa implements TranslationsVideoControlsPipErrorsEn {
	...
	@override String get permissionDisabled => 'ピクチャーインピクチャーの権限が無効です。設定 > アプリ > OXPlayer > ピクチャーインピクチャーで有効にしてください';
...
class _TranslationsCompanionRemotePairingJa implements TranslationsCompanionRemotePairingEn {
	...
	@override String get tipDesktop => 'デスクトップでOXPlayerを開き、設定またはメニューからコンパニオンリモートを有効にしてください';
...
extension on TranslationsJa {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'videoControls.pipErrors.permissionDisabled' => 'ピクチャーインピクチャーの権限が無効です。設定 > アプリ > OXPlayer > ピクチャーインピクチャーで有効にしてください',
			...
			'companionRemote.pairing.tipDesktop' => 'デスクトップでOXPlayerを開き、設定またはメニューからコンパニオンリモートを有効にしてください',
