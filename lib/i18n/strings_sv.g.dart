...
class TranslationsSv with BaseTranslations<AppLocale, Translations> implements Translations {
	...
	@override late final _TranslationsMyTelegramSv myTelegram = _TranslationsMyTelegramSv._(_root);
}
...
// Path: myTelegram
class _TranslationsMyTelegramSv implements TranslationsMyTelegramEn {
	_TranslationsMyTelegramSv._(this._root);
...
class _TranslationsVideoControlsPipErrorsSv implements TranslationsVideoControlsPipErrorsEn {
	...
	@override String get permissionDisabled => 'Bild-i-bild-behörighet är inaktiverad. Aktivera den i Inställningar > Appar > OXPlayer > Bild-i-bild';
...
class _TranslationsCompanionRemotePairingSv implements TranslationsCompanionRemotePairingEn {
	...
	@override String get tipDesktop => 'Öppna OXPlayer på din dator och aktivera Companion Remote via inställningar eller meny';
...
extension on TranslationsSv {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'videoControls.pipErrors.permissionDisabled' => 'Bild-i-bild-behörighet är inaktiverad. Aktivera den i Inställningar > Appar > OXPlayer > Bild-i-bild',
			...
			'companionRemote.pairing.tipDesktop' => 'Öppna OXPlayer på din dator och aktivera Companion Remote via inställningar eller meny',
