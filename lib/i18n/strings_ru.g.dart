...
class TranslationsRu with BaseTranslations<AppLocale, Translations> implements Translations {
	...
	@override late final _TranslationsMyTelegramRu myTelegram = _TranslationsMyTelegramRu._(_root);
}
...
// Path: myTelegram
class _TranslationsMyTelegramRu implements TranslationsMyTelegramEn {
	_TranslationsMyTelegramRu._(this._root);
...
class _TranslationsVideoControlsPipErrorsRu implements TranslationsVideoControlsPipErrorsEn {
	...
	@override String get permissionDisabled => 'Разрешение «картинка в картинке» отключено. Включите в Настройки > Приложения > OXPlayer > Картинка в картинке';
...
class _TranslationsCompanionRemotePairingRu implements TranslationsCompanionRemotePairingEn {
	...
	@override String get tipDesktop => 'Откройте OXPlayer на десктопе и включите пульт управления в настройках или меню';
...
extension on TranslationsRu {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'videoControls.pipErrors.permissionDisabled' => 'Разрешение «картинка в картинке» отключено. Включите в Настройки > Приложения > OXPlayer > Картинка в картинке',
			...
			'companionRemote.pairing.tipDesktop' => 'Откройте OXPlayer на десктопе и включите пульт управления в настройках или меню',
