...
class _TranslationsVideoControlsPipErrorsZh implements TranslationsVideoControlsPipErrorsEn {
	...
	@override String get permissionDisabled => '画中画权限已禁用。请在设置 > 应用 > OXPlayer > 画中画中启用';
...
class _TranslationsCompanionRemotePairingZh implements TranslationsCompanionRemotePairingEn {
	...
	@override String get tipDesktop => '在桌面上打开 OXPlayer，并从设置或菜单中启用 Companion Remote';
...
extension on TranslationsZh {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'videoControls.pipErrors.permissionDisabled' => '画中画权限已禁用。请在设置 > 应用 > OXPlayer > 画中画中启用',
			...
			'companionRemote.pairing.tipDesktop' => '在桌面上打开 OXPlayer，并从设置或菜单中启用 Companion Remote',
