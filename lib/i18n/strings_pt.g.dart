...
class TranslationsPt with BaseTranslations<AppLocale, Translations> implements Translations {
	...
	@override late final _TranslationsMyTelegramPt myTelegram = _TranslationsMyTelegramPt._(_root);
}
...
// Path: myTelegram
class _TranslationsMyTelegramPt implements TranslationsMyTelegramEn {
	_TranslationsMyTelegramPt._(this._root);
...
class _TranslationsVideoControlsPipErrorsPt implements TranslationsVideoControlsPipErrorsEn {
	...
	@override String get permissionDisabled => 'A permissão de picture-in-picture está desativada. Ative em Configurações > Apps > OXPlayer > Picture-in-picture';
...
class _TranslationsCompanionRemotePairingPt implements TranslationsCompanionRemotePairingEn {
	...
	@override String get tipDesktop => 'Abra o OXPlayer no desktop e ative o Controle Remoto nas configurações ou menu';
...
extension on TranslationsPt {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'videoControls.pipErrors.permissionDisabled' => 'A permissão de picture-in-picture está desativada. Ative em Configurações > Apps > OXPlayer > Picture-in-picture',
			...
			'companionRemote.pairing.tipDesktop' => 'Abra o OXPlayer no desktop e ative o Controle Remoto nas configurações ou menu',
