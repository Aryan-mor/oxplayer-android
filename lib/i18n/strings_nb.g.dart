...
class TranslationsNb with BaseTranslations<AppLocale, Translations> implements Translations {
	...
	@override late final _TranslationsMyTelegramNb myTelegram = _TranslationsMyTelegramNb._(_root);
}
...
// Path: myTelegram
class _TranslationsMyTelegramNb implements TranslationsMyTelegramEn {
	_TranslationsMyTelegramNb._(this._root);
...
class _TranslationsVideoControlsPipErrorsNb implements TranslationsVideoControlsPipErrorsEn {
	...
	@override String get permissionDisabled => 'Bilde-i-bilde-tillatelse er deaktivert. Aktiver den i Innstillinger > Apper > OXPlayer > Bilde-i-bilde';
...
class _TranslationsCompanionRemotePairingNb implements TranslationsCompanionRemotePairingEn {
	...
	@override String get tipDesktop => 'Åpne OXPlayer på datamaskinen din og aktiver Følgesvenn-fjernkontroll fra innstillinger eller meny';
...
extension on TranslationsNb {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'videoControls.pipErrors.permissionDisabled' => 'Bilde-i-bilde-tillatelse er deaktivert. Aktiver den i Innstillinger > Apper > OXPlayer > Bilde-i-bilde',
			...
			'companionRemote.pairing.tipDesktop' => 'Åpne OXPlayer på datamaskinen din og aktiver Følgesvenn-fjernkontroll fra innstillinger eller meny',
