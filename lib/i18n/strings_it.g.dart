...
class TranslationsIt with BaseTranslations<AppLocale, Translations> implements Translations {
	...
	@override late final _TranslationsMyTelegramIt myTelegram = _TranslationsMyTelegramIt._(_root);
}
...
// Path: myTelegram
class _TranslationsMyTelegramIt implements TranslationsMyTelegramEn {
	_TranslationsMyTelegramIt._(this._root);
...
class _TranslationsVideoControlsPipErrorsIt implements TranslationsVideoControlsPipErrorsEn {
	...
	@override String get permissionDisabled => 'L\'autorizzazione Picture-in-Picture è disabilitata. Abilitala in Impostazioni > App > OXPlayer > Picture-in-Picture';
...
class _TranslationsCompanionRemotePairingIt implements TranslationsCompanionRemotePairingEn {
	...
	@override String get tipDesktop => 'Apri OXPlayer sul tuo desktop e abilita Companion Remote dalle impostazioni o dal menu';
...
extension on TranslationsIt {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'videoControls.pipErrors.permissionDisabled' => 'L\'autorizzazione Picture-in-Picture è disabilitata. Abilitala in Impostazioni > App > OXPlayer > Picture-in-Picture',
			...
			'companionRemote.pairing.tipDesktop' => 'Apri OXPlayer sul tuo desktop e abilita Companion Remote dalle impostazioni o dal menu',
