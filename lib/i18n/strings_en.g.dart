...
class TranslationsVideoControlsPipErrorsEn {
	...
	/// en: 'Picture-in-picture permission is disabled. Enable it in Settings > Apps > OXPlayer > Picture-in-picture'
	String get permissionDisabled => 'Picture-in-picture permission is disabled. Enable it in Settings > Apps > OXPlayer > Picture-in-picture';
...
class TranslationsCompanionRemotePairingEn {
	...
	/// en: 'Open OXPlayer on your desktop and enable Companion Remote from settings or menu'
	String get tipDesktop => 'Open OXPlayer on your desktop and enable Companion Remote from settings or menu';
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'videoControls.pipErrors.permissionDisabled' => 'Picture-in-picture permission is disabled. Enable it in Settings > Apps > OXPlayer > Picture-in-picture',
			...
			'companionRemote.pairing.tipDesktop' => 'Open OXPlayer on your desktop and enable Companion Remote from settings or menu',
