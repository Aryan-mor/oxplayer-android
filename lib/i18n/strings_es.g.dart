...
class TranslationsEs with BaseTranslations<AppLocale, Translations> implements Translations {
	...
	@override late final _TranslationsMyTelegramEs myTelegram = _TranslationsMyTelegramEs._(_root);
}
...
// Path: myTelegram
class _TranslationsMyTelegramEs implements TranslationsMyTelegramEn {
	_TranslationsMyTelegramEs._(this._root);
...
class _TranslationsVideoControlsPipErrorsEs implements TranslationsVideoControlsPipErrorsEn {
	...
	@override String get permissionDisabled => 'El permiso de Imagen en Imagen está desactivado. Actívalo en Ajustes > Aplicaciones > OXPlayer > Imagen en Imagen';
...
class _TranslationsCompanionRemotePairingEs implements TranslationsCompanionRemotePairingEn {
	...
	@override String get tipDesktop => 'Abre OXPlayer en tu escritorio y activa Companion Remote desde los ajustes o el menú';
...
extension on TranslationsEs {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'videoControls.pipErrors.permissionDisabled' => 'El permiso de Imagen en Imagen está desactivado. Actívalo en Ajustes > Aplicaciones > OXPlayer > Imagen en Imagen',
			...
			'companionRemote.pairing.tipDesktop' => 'Abre OXPlayer en tu escritorio y activa Companion Remote desde los ajustes o el menú',
