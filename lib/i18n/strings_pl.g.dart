...
class TranslationsPl with BaseTranslations<AppLocale, Translations> implements Translations {
	...
	@override late final _TranslationsMyTelegramPl myTelegram = _TranslationsMyTelegramPl._(_root);
}
...
// Path: myTelegram
class _TranslationsMyTelegramPl implements TranslationsMyTelegramEn {
	_TranslationsMyTelegramPl._(this._root);
...
class _TranslationsVideoControlsPipErrorsPl implements TranslationsVideoControlsPipErrorsEn {
	...
	@override String get permissionDisabled => 'Uprawnienie obraz w obrazie jest wyłączone. Włącz w Ustawienia > Aplikacje > OXPlayer > Obraz w obrazie';
...
class _TranslationsCompanionRemotePairingPl implements TranslationsCompanionRemotePairingEn {
	...
	@override String get tipDesktop => 'Otwórz OXPlayer na komputerze i włącz Pilota zdalnego w ustawieniach lub menu';
...
extension on TranslationsPl {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'videoControls.pipErrors.permissionDisabled' => 'Uprawnienie obraz w obrazie jest wyłączone. Włącz w Ustawienia > Aplikacje > OXPlayer > Obraz w obrazie',
			...
			'companionRemote.pairing.tipDesktop' => 'Otwórz OXPlayer na komputerze i włącz Pilota zdalnego w ustawieniach lub menu',
