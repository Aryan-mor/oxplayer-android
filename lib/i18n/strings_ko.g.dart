...
class TranslationsKo with BaseTranslations<AppLocale, Translations> implements Translations {
	...
	@override late final _TranslationsMyTelegramKo myTelegram = _TranslationsMyTelegramKo._(_root);
}
...
// Path: myTelegram
class _TranslationsMyTelegramKo implements TranslationsMyTelegramEn {
	_TranslationsMyTelegramKo._(this._root);
...
class _TranslationsVideoControlsPipErrorsKo implements TranslationsVideoControlsPipErrorsEn {
	...
	@override String get permissionDisabled => '화면 속 화면 권한이 비활성화되어 있습니다. 설정 > 앱 > OXPlayer > 화면 속 화면에서 활성화하세요';
...
class _TranslationsCompanionRemotePairingKo implements TranslationsCompanionRemotePairingEn {
	...
	@override String get tipDesktop => '데스크톱에서 OXPlayer를 열고 설정 또는 메뉴에서 Companion Remote를 활성화하세요';
...
extension on TranslationsKo {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'videoControls.pipErrors.permissionDisabled' => '화면 속 화면 권한이 비활성화되어 있습니다. 설정 > 앱 > OXPlayer > 화면 속 화면에서 활성화하세요',
			...
			'companionRemote.pairing.tipDesktop' => '데스크톱에서 OXPlayer를 열고 설정 또는 메뉴에서 Companion Remote를 활성화하세요',
