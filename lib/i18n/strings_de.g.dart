...
class TranslationsDe with BaseTranslations<AppLocale, Translations> implements Translations {
	...
	@override late final _TranslationsMyTelegramDe myTelegram = _TranslationsMyTelegramDe._(_root);
}
...
class _TranslationsAppDe implements TranslationsAppEn {
	...
	// Translations
	@override String get title => 'OXPlayer';
}
...
// Path: myTelegram
class _TranslationsMyTelegramDe implements TranslationsMyTelegramEn {
	_TranslationsMyTelegramDe._(this._root);
	...
	@override String get supergroupsTab => 'Supergroups';
	@override String get channelsTab => 'Channels';
	@override String get botsTab => 'Bots';
	@override String get empty => 'No dialogs in this category with “Show in My Telegram” enabled. Open Configure to pick chats, then check Groups, Channels, or Bots if you do not see them here.';
	@override String get savedCheckOtherTabsHint => 'Saved. If this tab is still empty, open Groups, Channels, or Bots — your chat may be listed there.';
	...
	@override String get indexedForLibrary => 'Library indexing on';
	@override String get notIndexedForMedia => 'Turn on library indexing for this chat to list indexed files here.';
	@override String get mediaTitle => 'Media';
	@override String get mediaEmpty => 'No indexed media files in this chat yet.';
	@override String get mediaLoadError => 'Could not load media';
	@override String get loadMoreMedia => 'Load more';
	@override String get mediaSyncMayLoadMore => 'More videos may appear as Telegram finishes loading this chat.';
	@override String get checkForMoreVideos => 'Check for more videos';
	@override String get mediaEndOfList => 'No more videos to load in this chat.';
	@override String get tdlibChatMediaEmpty => 'No videos found in Telegram history for this chat yet. Only regular videos and sent video files are listed (like Telegram’s Videos tab), not GIFs or video notes. This is not the library “indexed” list.';
	@override String get forumTopicsLoadError => 'Could not load forum topics';
	@override String get forumTopicsEmpty => 'No topics found for this forum.';
	@override String get forumAllVideosTab => 'All videos';
	@override String get videoActionIndex => 'Index (forward to main bot)';
	@override String get videoActionStream => 'Stream';
	@override String get videoActionDownload => 'Download';
	@override String get videoStopDownload => 'Stop';
	...
	@override String get streamFailed => 'Could not start streaming';
...
class _TranslationsVideoControlsPipErrorsDe implements TranslationsVideoControlsPipErrorsEn {
	...
	@override String get permissionDisabled => 'Bild-in-Bild-Berechtigung ist deaktiviert. Aktiviere sie unter Einstellungen > Apps > OXPlayer > Bild-in-Bild';
...
class _TranslationsCompanionRemotePairingDe implements TranslationsCompanionRemotePairingEn {
	...
	@override String get tipDesktop => 'Öffne OXPlayer auf deinem Desktop und aktiviere Companion Remote in den Einstellungen oder im Menü';
...
extension on TranslationsDe {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'videoControls.pipErrors.permissionDisabled' => 'Bild-in-Bild-Berechtigung ist deaktiviert. Aktiviere sie unter Einstellungen > Apps > OXPlayer > Bild-in-Bild',
			...
			'companionRemote.pairing.tipDesktop' => 'Öffne OXPlayer auf deinem Desktop und aktiviere Companion Remote in den Einstellungen oder im Menü',
