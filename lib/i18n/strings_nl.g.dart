...
class TranslationsNl with BaseTranslations<AppLocale, Translations> implements Translations {
	...
	@override late final _TranslationsMyTelegramNl myTelegram = _TranslationsMyTelegramNl._(_root);
}
...
// Path: myTelegram
class _TranslationsMyTelegramNl implements TranslationsMyTelegramEn {
	_TranslationsMyTelegramNl._(this._root);
...
class _TranslationsVideoControlsPipErrorsNl implements TranslationsVideoControlsPipErrorsEn {
	...
	@override String get permissionDisabled => 'Beeld-in-beeld toestemming is uitgeschakeld. Schakel deze in via Instellingen > Apps > OXPlayer > Beeld-in-beeld';
...
class _TranslationsCompanionRemotePairingNl implements TranslationsCompanionRemotePairingEn {
	...
	@override String get tipDesktop => 'Open OXPlayer op je desktop en schakel Companion Remote in via instellingen of menu';
...
extension on TranslationsNl {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'videoControls.pipErrors.permissionDisabled' => 'Beeld-in-beeld toestemming is uitgeschakeld. Schakel deze in via Instellingen > Apps > OXPlayer > Beeld-in-beeld',
			...
			'companionRemote.pairing.tipDesktop' => 'Open OXPlayer op je desktop en schakel Companion Remote in via instellingen of menu',
