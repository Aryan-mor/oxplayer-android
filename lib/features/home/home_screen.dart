...
class HomeScreenFocusScope extends InheritedWidget {
  ...
  static HomeScreenFocusScope? of(BuildContext context) {
    return context.dependOnInheritedWidgetOfExactType<HomeScreenFocusScope>();
  }

  @override
  bool updateShouldNotify(HomeScreenFocusScope oldWidget) {
...
class HomeScreen extends StatefulWidget {
  ...
  const HomeScreen({super.key, this.client, this.isOfflineMode = false});

  @override
  State<HomeScreen> createState() => _HomeScreenState();
}

class _HomeScreenState extends State<HomeScreen> with RouteAware, WindowListener, WidgetsBindingObserver {
