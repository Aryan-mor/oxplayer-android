...
class OxplayerExpandableSection extends StatefulWidget {
  const OxplayerExpandableSection({
    super.key,
    required this.title,
    required this.child,
  ...
  @override
  State<OxplayerExpandableSection> createState() =>
      _OxplayerExpandableSectionState();
}

class _OxplayerExpandableSectionState extends State<OxplayerExpandableSection> {
