...
/// Dart-side wrapper for the `oxplayer/external_player` MethodChannel.
///
...
class ExternalPlayer {
  ...
  static const _channel = MethodChannel('oxplayer/external_player');
  static const _metaChannel = MethodChannel('oxplayer/media_utils');
